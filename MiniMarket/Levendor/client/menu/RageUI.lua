        ...
        if Enabled == true then
            ...
            if RageUI.CurrentMenu ~= nil then
                if RageUI.CurrentMenu() then
                    ...
                    RenderText(RageUI.CurrentMenu.Title, RageUI.CurrentMenu.X + RageUI.Settings.Items.Title.Text.X + (RageUI.CurrentMenu.WidthOffset / 2), RageUI.CurrentMenu.Y + RageUI.Settings.Items.Title.Text.Y, 2, RageUI.Settings.Items.Title.Text.Scale, 255, 255, 255, 255, 1)
